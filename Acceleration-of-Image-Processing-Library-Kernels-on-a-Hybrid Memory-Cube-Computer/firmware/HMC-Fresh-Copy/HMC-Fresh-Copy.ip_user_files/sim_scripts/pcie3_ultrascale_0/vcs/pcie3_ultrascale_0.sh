...
reset_run()
{
  files_to_remove=(ucli.key pcie3_ultrascale_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc pcie3_ultrascale_0_simv.daidir)
...
compile()
{
  ...
  vlogan -work gtwizard_ultrascale_v1_5_3 $opts_ver +v2k \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.pcie3_ultrascale_0 xil_defaultlib.glbl -o pcie3_ultrascale_0_simv
}
...
simulate()
{
  ...
  ./pcie3_ultrascale_0_simv $opts -do simulate.do
}
# Script usage
usage()
{
