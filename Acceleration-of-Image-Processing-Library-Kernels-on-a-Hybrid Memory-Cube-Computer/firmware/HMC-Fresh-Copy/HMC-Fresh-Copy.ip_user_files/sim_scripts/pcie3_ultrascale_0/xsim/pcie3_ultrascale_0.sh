...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcie3_ultrascale_0.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 2b304ec01c2e48f88062e4dc3e16c2f0 -m64 -L gtwizard_ultrascale_v1_5_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot pcie3_ultrascale_0 xil_defaultlib.pcie3_ultrascale_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pcie3_ultrascale_0 -key {Behavioral:sim_1:Functional:pcie3_ultrascale_0} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
