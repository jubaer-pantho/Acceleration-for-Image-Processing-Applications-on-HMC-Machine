...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k \
    "$ref_dir/../../../../HMC-Fresh-Copy.srcs/sources_1/ip/blk_mem_gen_0/blk_mem_gen_0_sim_netlist.v" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.blk_mem_gen_0 xil_defaultlib.glbl -o blk_mem_gen_0_simv
}
