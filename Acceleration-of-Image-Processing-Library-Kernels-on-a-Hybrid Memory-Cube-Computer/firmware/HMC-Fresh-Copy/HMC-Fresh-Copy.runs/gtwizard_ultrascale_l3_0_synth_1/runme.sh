...
HD_PWD='/home/hmc/Desktop/pantho/HMC-Fresh-Copy/HMC-Fresh-Copy.runs/gtwizard_ultrascale_l3_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gtwizard_ultrascale_l3_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source gtwizard_ultrascale_l3_0.tcl
