...
HD_PWD='/home/hmc/Desktop/pantho/HMC-Fresh-Copy/HMC-Fresh-Copy.runs/coregen_fifo_32x128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coregen_fifo_32x128.vds -m64 -mode batch -messageDb vivado.pb -notrace -source coregen_fifo_32x128.tcl
