...
HD_PWD='/home/hmc/Desktop/pantho/HMC-Fresh-Copy/HMC-Fresh-Copy.runs/async_fifo144_prim_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log async_fifo144_prim.vds -m64 -mode batch -messageDb vivado.pb -notrace -source async_fifo144_prim.tcl
