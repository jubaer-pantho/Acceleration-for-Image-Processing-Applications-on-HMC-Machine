...
HD_PWD='/home/hmc/Desktop/pantho/HMC-Fresh-Copy/HMC-Fresh-Copy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pico_Toplevel.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Pico_Toplevel.tcl
