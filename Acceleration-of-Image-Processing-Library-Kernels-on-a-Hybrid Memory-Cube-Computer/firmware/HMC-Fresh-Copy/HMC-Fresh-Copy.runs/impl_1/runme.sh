...
HD_PWD='/home/hmc/Desktop/pantho/HMC-Fresh-Copy/HMC-Fresh-Copy.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pico_Toplevel.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Pico_Toplevel.tcl -notrace
